...
public class Uyghur
{
	...
	public static void SavetoDOCXUEY(string filename, List<string> list, Uyghur.YEZIQ yeziq)
	{
			...
			foreach (string abzas in list)
			{
				...
				if (yeziq == Uyghur.YEZIQ.UEY)
				{
					...
					run.RunProperties = new RunProperties(
						new RunFonts() { Ascii = "Calibri", ComplexScript = "UKIJ Tuz", EastAsia = "SimSun" },
						new FontSize { Val = "28" },
						new FontSizeComplexScript { Val = "28" },
						new RightToLeftText()
					);
					run.AppendChild(new Text(abzas));
				}
				else {
					para.ParagraphProperties = new ParagraphProperties(
						new Justification() { Val = JustificationValues.Both }
					...
					run.RunProperties = new RunProperties(
						new FontSize { Val = "21" },
						new RunFonts() { Ascii = "Calibri", ComplexScript = "Calibri", EastAsia = "SimSun" }
					);
					run.AppendChild(new Text(abzas));
				}
			}
